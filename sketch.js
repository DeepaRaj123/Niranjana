...
var snake1,snake2,snakeImg,gameover;
var invisibleground,diamondcount=0;
var heart1;
var heart2;
var heart3,lives=3;
var diamondgroup;
var howtoplay,howtoplayImg,gamewin,gamewinImg;
var diamondhit,snakehit,buttonclick,theme,gamewinsound,gameoversound;
function preload(){
  ...
  playerImg2 = loadAnimation('png/Jump (1).png','png/Jump (2).png','png/Jump (3).png');
  playerImg3 = loadAnimation('png/Run (1).png','png/Run (2).png','png/Run (3).png');
...
diamondhit = loadSound("sounds/diamondhit.mp3");
snakehit = loadSound("sounds/snakehit.mp3");
buttonclick = loadSound("sounds/buttonclick.mp3");
...
function setup(){
  ...
  brick3 = createSprite(width/2+100,height/2-75);
  ...
  player.addAnimation("jump",playerImg2);
  player.addAnimation("right",playerImg3);  player.scale =0.23;
  ...
  snake3 = createSprite(windowWidth/2+70,windowHeight-300); 
  ...
  howtoplay = createSprite(windowWidth/2+50,windowHeight/2);
  howtoplay.addImage(howtoplayImg);
  howtoplay.scale = 0.3;
  howtoplay.visible = false;

  gamewin = createSprite(windowWidth/2+50,windowHeight/2);
  gamewin.addImage(gamewinImg);
  gamewin.scale = 0.3;
  gamewin.setCollider("circle",0,-500,150);
...
function draw() {
  ...
  {
    player.velocityY = -12;
    player.changeAnimation("jump",playerImg2);
  }
  if(keyDown("right_arrow"))
  {
    player.x = player.x +3;
    player.changeAnimation("right",playerImg3);
